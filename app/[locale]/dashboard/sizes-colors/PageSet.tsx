      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h1 className="text-2xl font-bold text-slate-800">
            {language === 'bn' ? 'সাইজ ও রঙসমূহ' : 'Sizes & Colors Configuration'}
          </h1>
          <p className="text-sm text-slate-500">
            {language === 'bn' ? 'পণ্যের সাইজ ভ্যারিয়েন্ট ও রঙের কোড নিয়ন্ত্রণ করুন' : 'Manage your product variant dimensions and custom color palette'}
          </p>
        </div>
      </div>
