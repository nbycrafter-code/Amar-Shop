...
import { Trash2, Globe, Search, Edit2, ShieldCheck } from "lucide-react";
          ...
          <table className="w-full text-left border-collapse">
            ...
            <tbody className="divide-y divide-slate-100">
              {currentItems.length > 0 ? (
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          >
                            {brand.image && brand.image.startsWith("/uploads/") ? (
                              <Image src={brand.image} alt={brand.name} className="w-6 h-6 object-contain" width={40} height={40} style={{ backgroundColor: brand.imageBgColor || "transparent" }} />
                            ) : (
                ...
                <tr><td colSpan={4} className="py-8 text-center text-sm text-slate-500">{language === 'bn' ? "কোনো ব্র্যান্ড পাওয়া যায়নি।" : "No brands found."}</td></tr>
              )}
            </tbody>
          </table>
        </div>
